...
public class main4 {
    ...
    public static void main(String[] args){
        ...
        if(calcularMedia >= 7){
            JOptionPane.showMessageDialog(null, "Aprovado - Média final: " +calcularMedia, "Media", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(null, "Reprovado - Média final:  " +calcularMedia, "Media", JOptionPane.INFORMATION_MESSAGE);
        }
